...
class _TodayAttendanceScreenState
  ...
  List<Map<String, dynamic>> interns = [
    ...
    {"name": "Aakash Verma", "status": "present"},
    {"name": "Sneha Kulkarni", "status": "leave"},
    {"name": "Rohan Mehta", "status": "present"},
  ];

  /// NAVIGATE TO DATE SCREEN
  Future<void> changeDate() async {
    ...
    final selected = await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) =>
            AttendanceDateSelectorScreen(currentDate: selectedDate),
      ),
    );
  ...
  int leaveCount() =>
      interns.where((e) => e["status"] == "leave").length;
